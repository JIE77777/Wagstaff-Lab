...
[green]bin/wagstaff wiki recipe <配方名/产物名>[/green]
[green]bin/wagstaff wiki recipe tab <TAB>[/green]            按制作栏大类列出
[green]bin/wagstaff wiki recipe filter <FILTER>[/green]      按筛选分类列出
[green]bin/wagstaff wiki recipe who <TAG>[/green]            按角色专属列出 (builder_tag)
[green]bin/wagstaff wiki recipe tech <TECH>[/green]          按科技需求列出
[green]bin/wagstaff wiki recipe uses <ITEM>[/green]          反查：哪些配方需要该材料
[green]bin/wagstaff wiki recipe can <INV>[/green]            给定材料，列出可制作配方
[green]bin/wagstaff wiki recipe missing <R> <INV>[/green]    给定材料，查看缺少哪些
[green]bin/wagstaff wiki recipe tabs[/green]                 查看 TAB 顺序
[green]bin/wagstaff wiki recipe filters[/green]              查看 FILTER 定义(含icon字段)

[green]bin/wagstaff wiki food <食谱名>[/green]                查询烹饪食谱(准备食物)
[green]bin/wagstaff wiki food can <INV>[/green]              近似：按 card_ingredients 判断可做食谱

[green]bin/wagstaff wiki mob <生物名>[/green]                查询生物/物品详情
[green]bin/wagstaff wiki loot <表名>[/green]                 查询掉落表
[green]bin/wagstaff wiki find <关键词>[/green]               交互式代码搜索
