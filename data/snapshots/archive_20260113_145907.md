...
- Generated: 2026-01-13T14:59:07
- Mode: archive
- Template: archive

## 1. Environment Diagnostics
```yaml
Time: 2026-01-13 14:59:07
User: steam
...
│   ├── sampler.py
│   └── snapshot.py
├── project_context.focus_analyzer.txt
├── PROJECT_STATUS.json
├── README.md
├── setup.sh
├── src
...
full | 6622  | 47ca5ca9e88a | conf/snapshot_templates.json                      
...
full | 6674  | a18caa6ebf79 | devtools/pm.py                                    
...
skip | 69680 | -            | project_context.focus_analyzer.txt                
skip | 896   | -            | setup.sh                                          
...
full | 2414  | 49f94a18019d | src/registry.py                                   
full | 1040  | ffc01cb3d8f3 | src/utils.py                                      
full | 10180 | c9d6c059d8a1 | src/wiki.py                                       
